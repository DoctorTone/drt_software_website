  ...
  return (
    <Container>
      ...
      <Row className="mb-3">
        ...
        <Col xs={6} md={4} className="mb-3 text-center">
          <Image src="./images/portfolio.jpg" rounded fluid className="mb-2" />
          <h6>3D Websites</h6>
        </Col>
      </Row>
      <Row className="mb-1">
      ...
      <Row className="mb-1">
        ...
        <Col xs={11}>A 3D product configurator for the bathroom industry.</Col>
      </Row>
      <Row className="mb-1">
        <Col xs={1} className="text-center">
          <BrightnessHigh color="orange" size={20} />
      ...
      <Row className="text-center mt-5">
        <p>
          These are some of the people I've been fortunate enough to work with:
        </p>
      </Row>
      <Row className="mb-3 align-items-center">
        <Col xs={6} md={4} lg={3} xl={{ span: 2, offset: 1 }} className="mb-2">
